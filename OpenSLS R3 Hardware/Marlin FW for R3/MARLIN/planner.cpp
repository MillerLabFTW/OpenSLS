...
void check_axes_activity()
{
  ...
  unsigned char tail_fan_speed2 = fanSpeed2;
  #ifdef BARICUDA
  ...
  if(block_buffer_tail != block_buffer_head)
  {
    ...
    tail_fan_speed2 = block_buffer[block_index].fan_speed2;
    #ifdef BARICUDA
...
#if defined(DC_MOTOR_SIGNAL_SLAVE) && DC_MOTOR_SIGNAL_SLAVE > -1
  ...
  #else
  analogWrite(DC_MOTOR_SIGNAL_SLAVE,tail_fan_speed);
  #endif//!FAN_SOFT_PWM
#endif//DC_MOTOR_SIGNAL_SLAVE > -1

#if defined(SERVO_SIGNAL_SLAVE) && SERVO_SIGNAL_SLAVE > -1
  #ifdef FAN_KICKSTART_TIME
    static unsigned long fan_kick_end;
    if (tail_fan_speed2) {
      if (fan_kick_end == 0) {
  ...
  #endif//FAN_KICKSTART_TIME
  #ifdef FAN_SOFT_PWM
  fanSpeedSoftPwm = tail_fan_speed2;
  #else
  analogWrite(SERVO_SIGNAL_SLAVE,tail_fan_speed2);
  #endif//!FAN_SOFT_PWM
#endif//DC_MOTOR_SIGNAL_SLAVE > -1
